...
public class CineApp {
	...
	public static void main(String[] args) {
		...
		Peliculas l = new Peliculas("Malditos bastardos", 120, 18, "Quentin Tarantino");
		Peliculas la = new Peliculas("Big hero 6", 120, 12, "Chris Williams");
		Peliculas ls = new Peliculas("Forzen", 120, 3, "Chris Buck");
		...
		//Por cada espectador comprobamos si puede ver la pelicula
		int numEspec=0;
